...
export enum BorrowStatus { BORROWING = 'BORROWING', RETURNED = 'RETURNED', AUTO_RETURNED = 'AUTO_RETURNED', OVERDUE = 'OVERDUE', LOST = 'LOST' }
...
export enum ReceiveMethod { LIBRARY_PICKUP = 'LIBRARY_PICKUP', HOME_PICKUP = 'HOME_PICKUP' }
export enum ReturnMethod { LIBRARY_RETURN = 'LIBRARY_RETURN', HOME_RETURN = 'HOME_RETURN' }
