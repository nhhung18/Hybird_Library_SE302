          ...
          <motion.div key={book.id} whileHover={{ y: -8 }} className="group cursor-pointer p-3 glass-panel rounded-[2.5rem] transition-all hover:shadow-xl flex flex-col justify-between">
            ...
            <div className="space-y-3 px-2 pb-1 flex-1 flex flex-col justify-end">
              ...
              <div className="flex items-center space-x-2 pt-2">
                <button
                  className={`flex-1 py-3 rounded-full font-bold text-xs transition-all ${book.status === 'active' ? 'bg-[#1e3b2b] text-white shadow-md shadow-[#1e3b2b]/20 hover:shadow-lg hover:-translate-y-0.5' : 'bg-white/50 border border-white/60 text-gray-400 cursor-not-allowed'}`}
                >
