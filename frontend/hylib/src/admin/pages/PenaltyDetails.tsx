      ...
      <main className="flex-1 ml-64 flex flex-col h-screen overflow-hidden">
        ...
        <div className="bg-white border-b border-gray-200 px-8 py-4 flex items-center justify-between shrink-0">
          <button 
            ...
            className="flex items-center gap-2 text-gray-500 hover:text-[#0056b3] font-bold text-sm transition-colors active:scale-95"
          >
            <ArrowLeft size={18} />
            Quay lại danh sách
          </button>
          <button className="flex items-center gap-2 px-5 py-2.5 bg-white border border-gray-200 rounded-full text-sm font-bold text-gray-700 hover:bg-gray-50 transition-colors shadow-sm active:scale-95">
            <Printer size={16} />
            In biên lai
          </button>
        </div>

        <div className="flex-1 p-8 flex justify-center overflow-y-auto custom-scrollbar">
